  ...
  useEffect(() => {
    const fetchDemandes = async () => {
      try {
        ...
        const response = await fetch(`http://192.168.88.18:8080/api/v1/${authRole}/demande/2`, {
          headers: {
        ...
        <Row className="mt-5">
          <div className="col">
            <Card className="shadow bg-default">
              ...
              <h3 className="mb-0 text-white"> Nouvelles demandes reçues</h3>
<div>
                        ...
                        <td className="text-right">
                          <UncontrolledDropdown>
                            ...
                            <DropdownMenu className="dropdown-menu-arrow" right>
                              <DropdownItem
                               onClick={() => navigate(`/DPR_SAF/demande/detail/${demande.id}`)}>
                                Detail
                              </DropdownItem>
                            </DropdownMenu>
                          </UncontrolledDropdown>
