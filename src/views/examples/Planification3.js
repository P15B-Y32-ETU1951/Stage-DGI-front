...
const Planification3 = () => {
  ...
  const formatDate = (date) => {
    if (!date) return null;
    return moment(date).format('YYYY-MM-DD'); // Utilise moment pour normaliser
  };
  ...
  const validDateDebut = (current) => current.isSameOrAfter(moment(), 'day');
                    ...
                    <FormGroup>
                      ...
                      <InputGroup className="input-group-alternative" style={{ width: '100%' }}>
                        ...
                        <ReactDatetime
                          ...
                          onChange={(date) => setDateDebutEtape(moment(date).toDate())}
                        />
                      </InputGroup>
                    </FormGroup>
                  </Col>
                    ...
                    <FormGroup>
                      ...
                      <InputGroup className="input-group-alternative" style={{ width: '100%' }}>
                        ...
                        <ReactDatetime
                          ...
                          onChange={(date) => setDateFinEtape(moment(date).toDate())}
                        />
                      </InputGroup>
                    </FormGroup>
                  </Col>
